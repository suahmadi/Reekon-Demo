...
const HomeBanner = ({ onCursor }) => {
  ...
  return (
    <Banner>
      ...
      <Canvas
        height={typeof window !== "undefined" && size.height}
        width={typeof window !== "undefined" && size.width}
        ref={canvas}
      ...
      <BannerTitle
        ...
        positionTransition=""
      >
        <Headline variants={item}>MOVE</Headline>
        <Headline variants={item}>FORWARD</Headline>
      </BannerTitle>
    </Banner>
  )
}
